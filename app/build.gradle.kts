...
android {
    namespace = "com.example.coffeeshop"; compileSdk = 34
    defaultConfig { applicationId = "com.example.coffeeshop"; minSdk = 24; targetSdk = 34; versionCode = 1; versionName = "1.0" }
...
dependencies {
    ...
    ksp("androidx.room:room-compiler:2.6.1"); implementation("com.github.bumptech.glide:glide:4.16.0")
}
